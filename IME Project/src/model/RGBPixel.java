...
/**
 * The Pixel class represents a single pixel in an image, storing its row and column numbers,
...
public class RGBPixel implements Pixel {
  ...
  /**
   Constructor to initialize the Pixel object with the provided properties.
